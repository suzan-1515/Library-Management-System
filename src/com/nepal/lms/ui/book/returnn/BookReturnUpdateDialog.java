...
public class BookReturnUpdateDialog extends BaseBookTransaction {
    ...
    private void fillFields() {
        bookIdTextField.setText(String.valueOf(returnn.getBook().getId()));
        memberIdTextField.setText(String.valueOf(returnn.getMember().getId()));
    }

    public interface ItemUpdatedListener {

        void onItemUpdated(Return returnn);
    }

    /**
     * Creates new form BookReturnInsertDialog
     *
     * @param parent
     * @param modal
     * @param returnn
     */
    public BookReturnUpdateDialog(java.awt.Frame parent, boolean modal, Return returnn) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Return Detail");
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        if (validation.isReturnFormValid(bookIdTextField.getText(), memberIdTextField.getText())) {
            ...
            Book bookById = getBook(bookIdTextField.getText());
            if (bookById != null) {
                ...
                if (member != null) {
                    ...
                    try {
                        ReturnBLL.updateReturn(returnn);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookReturnUpdateDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            BookReturnUpdateDialog dialog = new BookReturnUpdateDialog(new javax.swing.JFrame(), true, new Return());
