 ...
 * @author Suzn
 */
public class BookAuthorUpdateDialog extends javax.swing.JDialog {
    ...
    private void notifyDataSetChanged(Author author) {
        if (getItemUpdatedListener() != null) {
            getItemUpdatedListener().onItemUpdated(author);
        }
    }
    ...
    private void fillFields() {
        titleTextField.setText(author.getTitle());
        contactTextField.setText(author.getContact());
    }

    public interface ItemUpdatedListener {

        void onItemUpdated(Author author);
    }
     ...
     * @param author
     */
    public BookAuthorUpdateDialog(java.awt.Frame parent, boolean modal, Author author) {
        super(parent, modal);
        initComponents();
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        if (validation.isAuthorFormValid(titleTextField.getText(), contactTextField.getText())) {
            ...
            try {
                AuthorBLL.updateAuthor(author);
                notifyDataSetChanged(author);
                Alert.showInformation(this, "Author updated successfully!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookAuthorUpdateDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            BookAuthorUpdateDialog dialog = new BookAuthorUpdateDialog(new javax.swing.JFrame(), true, new Author());
