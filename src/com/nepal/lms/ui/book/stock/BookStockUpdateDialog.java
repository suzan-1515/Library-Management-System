 ...
 * @author Suzn
 */
public class BookStockUpdateDialog extends javax.swing.JDialog {
    ...
    private ItemUpdatedListener itemUpdatListener;

    private void notifyDataSetChanged(BookInfo bookInfo) {
        if (getItemUpdatListener() != null) {
            getItemUpdatListener().onItemUpdated(bookInfo);
        }
    }

    private void fillFields() {
        titleTextField.setText(bookInfo.getTitle());
        subjectComboBox.getModel().setSelectedItem(bookInfo.getSubject());
        publisherComboBox.getModel().setSelectedItem(bookInfo.getPublisher());
        authorComboBox.getModel().setSelectedItem(bookInfo.getAuthor());
        editionTextField.setText(bookInfo.getEdition());
        isbnTextField.setText(bookInfo.getIsbn());
        quantityTextField.setText(String.valueOf(bookInfo.getNumberOfCopy()));
     ...
     * @param bookInfo
     */
    public BookStockUpdateDialog(java.awt.Frame parent, boolean modal, BookInfo bookInfo) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        subjectComboBox = new javax.swing.JComboBox<com.nepal.lms.entity.subject.Subject>();
        ...
        subjectComboBox.setModel(new javax.swing.DefaultComboBoxModel<com.nepal.lms.entity.subject.Subject>());
        ...
        authorComboBox.setModel(new javax.swing.DefaultComboBoxModel<com.nepal.lms.entity.author.Author>());
        ...
        publisherComboBox.setModel(new javax.swing.DefaultComboBoxModel<com.nepal.lms.entity.publisher.Publisher>());
        ...
        shelfComboBox.setModel(new javax.swing.DefaultComboBoxModel<com.nepal.lms.entity.shelf.Shelf>());
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if (validation.isStockFormValid(titleTextField.getText(),
            ...
            bookInfo.setSubject((Subject) subjectComboBox.getModel().getSelectedItem());
            bookInfo.setAuthor((Author) authorComboBox.getModel().getSelectedItem());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookStockUpdateDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            BookStockUpdateDialog dialog = new BookStockUpdateDialog(new javax.swing.JFrame(), true, new BookInfo());
    ...
    private javax.swing.JComboBox<com.nepal.lms.entity.author.Author> authorComboBox;
    ...
    private javax.swing.JComboBox<com.nepal.lms.entity.publisher.Publisher> publisherComboBox;
    private javax.swing.JTextField quantityTextField;
    private javax.swing.JPanel rootPanel;
    private javax.swing.JButton saveButton;
    private javax.swing.JButton shelfAddButton;
    private javax.swing.JComboBox<com.nepal.lms.entity.shelf.Shelf> shelfComboBox;
    private javax.swing.JButton subjectAddButton;
    private javax.swing.JComboBox<com.nepal.lms.entity.subject.Subject> subjectComboBox;
    ...
    /**
     * @return the itemUpdatListener
     */
    public ItemUpdatedListener getItemUpdatListener() {
        return itemUpdatListener;
    }

    /**
     * @param itemUpdatListener the itemUpdatListener to set
     */
    public void setItemUpdatListener(ItemUpdatedListener itemUpdatListener) {
        this.itemUpdatListener = itemUpdatListener;
    }
