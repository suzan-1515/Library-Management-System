 ...
 * @borrow Suzn
 */
public class BookBorrowUpdateDialog extends BaseBookTransaction {
    ...
    private void notifyDataSetChanged(Borrow borrow) {
        if (getItemUpdatedListener() != null) {
            getItemUpdatedListener().onItemUpdated(borrow);
        }
    }
    ...
    private void fillFields() {
        bookIdTextField.setText(String.valueOf(borrow.getBook().getId()));
        memberIdTextField.setText(String.valueOf(borrow.getMember().getId()));
        expiryDateChooser.setSelectedDate(Utils.millisToCalendar(borrow.getReturningDate()));
    }

    public interface ItemUpdatedListener {

        void onItemUpdated(Borrow borrow);
    }
     ...
     * @param borrow
     */
    public BookBorrowUpdateDialog(java.awt.Frame parent, boolean modal, Borrow borrow) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel3, memberIdTextField});
                ...
                if (validation.isBookAvailable(bookById.getAvailableCopies())) {
                    ...
                    if (member != null) {
                        if (validation.isMemberValid(member.getExpiryDate())) {
                            ...
                            try {
                                BorrowBLL.updateBorrow(borrow);
                                notifyDataSetChanged(borrow);
                                Alert.showInformation(this, "Borrow details updated successfully!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookBorrowUpdateDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            BookBorrowUpdateDialog dialog = new BookBorrowUpdateDialog(new javax.swing.JFrame(), true, new Borrow());
