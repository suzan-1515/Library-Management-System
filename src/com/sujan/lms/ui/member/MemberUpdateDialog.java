 ...
 * @member Suzn
 */
public class MemberUpdateDialog extends javax.swing.JDialog {
    ...
    private void notifyDataSetChanged(MemberInfo member) {
        if (getItemUpdatedListener() != null) {
            getItemUpdatedListener().onItemUpdated(member);
        }
    }
    ...
    public interface ItemUpdatedListener {
        ...
        void onItemUpdated(MemberInfo member);
    }

    /**
     * Creates new form MemberMemberInsertDialog
     *
     * @param parent
     * @param modal
     * @param member
     */
    public MemberUpdateDialog(java.awt.Frame parent, boolean modal, MemberInfo member) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5.setLayout(new java.awt.GridLayout(4, 2, 0, 5));
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        if (validation.isMemberFormValid(nameTextField.getText(), addressTextField.getText(), contactTextField.getText(),
            ...
            try {
                ...
                Alert.showInformation(this, "Member updated successfully!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MemberUpdateDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MemberUpdateDialog dialog = new MemberUpdateDialog(new javax.swing.JFrame(), true, new MemberInfo());
