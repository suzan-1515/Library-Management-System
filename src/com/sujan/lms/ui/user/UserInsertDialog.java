 ...
 * @author Suzn
 */
public class UserInsertDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public UserInsertDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        roleComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Librarian" }));
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if (validation.isUserFormValid(nameTextField.getText(), userTextField.getText(),
            ...
            user.setRole(new Role(roleComboBox.getSelectedIndex(), (String) roleComboBox.getSelectedItem()));

            try {
                UserBLL.insertUser(user);
                notifyDataSetChanged(user);
                Alert.showInformation(this, "User inserted successfully!");

                resetFields();
            } catch (DuplicateRecordException | MissingFileException
                    | CorruptedDataException | UnAvailableUsernameException ex) {
                Logy.e(ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserInsertDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            UserInsertDialog dialog = new UserInsertDialog(new javax.swing.JFrame(), true);
