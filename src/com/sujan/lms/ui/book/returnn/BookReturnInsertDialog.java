 ...
 */
package com.sujan.lms.ui.book.returnn;
 ...
 * @returnn Suzn
 */
public class BookReturnInsertDialog extends BaseBookTransaction {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Return Detail");
        ...
        if (validation.isReturnFormValid(bookIdTextField.getText(), memberIdTextField.getText())) {
            ...
            if (bookInfo != null) {
                ...
                if (validation.isBookAvailable(bookInfo.getAvailableCopies())) {
                    ...
                    Logy.d("Invalid book return");
                    Alert.showError(this, "Book already returned");
                }
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookReturnInsertDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
